...
CREATE TABLE meta_personalizada (
    id_meta_personalizada INT AUTO_INCREMENT PRIMARY KEY,
    id_usuario INT,
    descripcion VARCHAR(100) NOT NULL,
...
CREATE TABLE objetivo_personalizado (
    id_objetivo_personalizado INT AUTO_INCREMENT PRIMARY KEY,
    id_usuario INT,
    descripcion VARCHAR(100) NOT NULL,
    FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario) ON DELETE CASCADE
);
...
CREATE TABLE meta_objetivo (
    ...
    id_meta INT,
    id_objetivo INT,
    id_meta_personalizada INT,
    id_objetivo_personalizado INT,
    FOREIGN KEY (id_categoria) REFERENCES categoria(id_categoria),
    FOREIGN KEY (id_meta) REFERENCES meta(id_meta),
    FOREIGN KEY (id_objetivo) REFERENCES objetivo(id_objetivo),
    FOREIGN KEY (id_meta_personalizada) REFERENCES meta_personalizada(id_meta_personalizada) ON DELETE CASCADE,
    FOREIGN KEY (id_objetivo_personalizado) REFERENCES objetivo_personalizado(id_objetivo_personalizado) ON DELETE CASCADE
); 
