...
import {
  ...
  updateActividad,
  getDiasSemana,
  saveMetaPersonalizada,
  saveObjetivoPersonalizado,
  saveMetaObjetivoPersonalizado,
...
router.post("/meta-personalizada", saveMetaPersonalizada);
router.post("/objetivo-personalizado", saveObjetivoPersonalizado);
router.post("/meta-objetivo-personalizado", saveMetaObjetivoPersonalizado);
