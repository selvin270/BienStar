...
const NuevaActividadFisica = ({ navigation }) => {
    ...
    const fetchMetas = async () => {
      try {
        ...
        const response = await axios.get(
          `http://192.168.10.216:4000/metas/3/${idiomaSeleccionado}`
        );
    ...
    try {
      ...
      const metaObjetivoResponse = await axios.post(
        "http://192.168.10.216:4000/meta-objetivo-personalizado",
        {
          ...
          id_categoria: 3, // Ajusta según la lógica
        }
      );
      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("ActividadNutricional")} // Navigate back
          >
...
const styles = StyleSheet.create({
  ...
  agregarHorario: {
    backgroundColor: "#97c033", // Background color
...
export default NuevaActividadFisica;
